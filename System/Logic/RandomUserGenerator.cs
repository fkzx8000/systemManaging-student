...
namespace TDD_work.Logic
{
    public class RandomUserGenerator
    {
        ...
        private static string strGeberator()
        {
            int stringlen = Instance.Next(4, 10);
            int randValue;
            string str = "";
            char letter;
        ...
        {
            // Return random email
            return strGeberator() + "@" + strGeberator() + ".com";
        }

        protected static string generateID()
        {
            // Return random id
            return Instance.Next(100000000, 999999999).ToString();
        }

        protected static string genaratePhone()
        {
            // Return random phone number
            return Instance.Next(100, 999).ToString() + "-" + Instance.Next(1000000, 9999999).ToString();
        }

        protected static string generateGrade()
        {
            // Generate random grade o-100 or 777

            if (Instance.Next(0,12).Equals(0))
            {
                return 777.ToString();
            }
        
            return Instance.Next(0, 100).ToString();
        }
        ...
        protected static string generateFirstName()
        {
            ...
            {
                "Daniil", "Danish", "Daniyal", "Danniel", "Danny", "Dante", "Danyal", "Danyil", "Danys", "Daood", "Dara", "Darach", "Daragh", "Darcy", "D'arcy", "Dareh", "Daren", "Darien", "Darius", "Darl", "Darn", "Darrach", "Darragh", "Darrel", "Darrell", "Darren", "Darrie", "Darrius", "Darroch", "Darryl", "Darryn", "Darwyn", "Daryl", "Daryn", "Daud", "Daumantas", "Davi", "David", "David-Jay", "David-Lee", "Davie", "Davis", "Davy", "Dawid", "Dawson", "Dawud", "Dayem", "Daymian", "Deacon", "Deagan", "Dean", "Deano", "Decklan", "Declain", "Declan", "Declyan", "Declyn", "Dedeniseoluwa", "Deecan", "Deegan", "Deelan", "Deklain-Jaimes", "Del", "Demetrius", "Denis", "Deniss", "Dennan", "Dennin", "Dennis", "Denny", "Dennys", "Denon", "Denton", "Denver", "Denzel", "Deon", "Derek", "Derick", "Derin", "Dermot", "Derren", "Derrie", "Derrin", "Derron", "Derry", "Derryn", "Deryn", "Deshawn", "Desmond", "Dev", "Devan", "Devin", "Devlin", "Devlyn", "Devon", "Devrin", "Devyn", "Dex", "Dexter", "Dhani", "Dharam", "Dhavid", "Dhyia", "Diarmaid", "Diarmid", "Diarmuid", "Didier", "Diego", "Diesel", "Diesil", "Digby", "Dilan", "Dilano", "Dillan", "Dillon", "Dilraj", "Dimitri", "Dinaras", "Dion", "Dissanayake", "Dmitri", "Doire", "Dolan", "Domanic", "Domenico", "Domhnall", "Dominic", "Dominick", "Dominik", "Donald", "Donnacha", "Donnie", "Dorian", "Dougal", "Douglas", "Dougray", "Drakeo", "Dre", "Dregan", "Drew", "Dugald", "Duncan", "Duriel", "Dustin", "Dylan", "Dylan-Jack", "Dylan-James", "Dylan-John", "Dylan-Patrick", "Dylin", "Dyllan", "Dyllan-James", "Dyllon", "Eadie", "Eagann", "Eamon", "Eamonn", "Eason", "Eassan", "Easton", "Ebow", "Ed", "Eddie", "Eden", "Ediomi", "Edison", "Eduardo", "Eduards", "Edward", "Edwin", "Edwyn", "Eesa", "Efan", "Efe", "Ege", "Ehsan", "Ehsen", "Eiddon", "Eidhan", "Eihli", "Eimantas", "Eisa", "Eli", "Elias", "Elijah", "Eliot", "Elisau", "Eljay", "Eljon", "Elliot", "Elliott", "Ellis", "Ellisandro", "Elshan", "Elvin", "Elyan", "Emanuel", "Emerson", "Emil", "Emile", "Emir", "Emlyn", "Emmanuel", "Emmet", "Eng", "Eniola", "Enis", "Ennis", "Enrico", "Enrique", "Enzo"
            };

            return list.ElementAt(Instance.Next(0, list.Count - 1));
        }
        ...
        {
            // Make one random user
            var g1 = generateGrade();
            var g2 = generateGrade();
            var g3 = generateGrade();
            var g4 = generateGrade();
            var g5 = generateGrade();
            ...
            return new UserData
            {
                ...
                ID = generateID(),
                Email = generateEmail(),
                PhoneNumber = genaratePhone(),
                Physics = g1,
                Calculus = g2,
                ComputerScience = g3,
                History = g4,
                IndustrialEngineering = g5,
                AverageGrade = ControlCSV.AverageGradeOfFive(g1, g2, g3, g4, g5)
            };
        }
    }
}
